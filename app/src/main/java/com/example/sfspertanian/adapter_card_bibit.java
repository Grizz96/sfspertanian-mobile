...
public class adapter_card_bibit extends RecyclerView.Adapter<adapter_card_bibit.ViewHolder> {
    ...
    public adapter_card_bibit(List<DataItem> dataItemList, OnItemClickListener listener) {
